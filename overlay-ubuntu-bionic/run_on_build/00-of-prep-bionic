...
# 00-of-prep-bionic v1.07 (17th May 2020)
#  Set up the basics.
...
# Additions
APT_SYSTEM="acpi bash-completion bc bluez curl dosfstools htop i2c-tools initramfs-tools locales libbsd0 libcrystalhd3 libdaemon0 libedit2 libio-socket-ssl-perl libnet-ssleay-perl libpango1.0-0 libwrap0 libx11-6 libx11-data libxau6 libxcb1 libxdmcp6 libxext6 libxmuu1 nano net-tools netplan.io ntpdate patch pciutils plymouth policykit-1 psmisc rsync sudo tcpd usbutils usb-modeswitch usb-modeswitch-data unclutter unzip usbmount uuid wget wpasupplicant wireless-tools x11-xserver-utils xauth xinput zlibc"
